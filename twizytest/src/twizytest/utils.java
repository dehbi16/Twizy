...
public class utils {
	...
	public static void exo01(String title) {
		Mat mat = Image.LectureImage(title);
		...
		for (int i=0; i<channels.size(); i++) {
			...
			Image.ImShow(Integer.toString(i), dst);
	...
	public static void exo02(String title) {
		...
		for (int i=0; i<3; i++) {
			...
			Image.ImShow(Integer.toString(i), res);
		}
